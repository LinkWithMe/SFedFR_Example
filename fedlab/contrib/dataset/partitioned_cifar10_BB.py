...
from ...utils.dataset.partition import CIFAR10Partitioner, FMNISTPartitioner
...
class PartitionedCIFAR10(FedDataset):
    ...
    def preprocess(self,
        ...
        """
        print("你已经执行到了分区步骤！")
        csv_file = "../partition-reports//Shards/cifar10_Shards3_200客户端_3.csv"
        ...
        # plt.show()
        # plt.savefig("../partition-reports//Shards/cifar10_Shards3_200客户端_3.png")
        # plt.close()
