...
from fedlab.models.cnnsnn import SNNCNN_FMNIST_BB, SNNCNN_CIFAR10_CifarNet,CSNN_FMNIST,CNN_FLANC
...
model = CSNN_FMNIST(T=args.T, channels=args.channels)
...
# mnist = PartitionedFashionMNIST(root='../datasets/fmnist/',
#                          path="../datasets/fmnist/client50_unbalance_alpha0.3/",
...
#                                 )
mnist = PartitionedFashionMNIST(root='../datasets/fmnist/',
                         path="../datasets/fmnist/client200_Shards_3/",
                         # path="../datasets/fmnist/alpha2",
                         num_clients=args.total_client,
                         # partition="unbalance",
...
while handler.if_stop is False:
    ...
    print("Round {}, Test Accuracy: {:.4f}, Max Acc: {:.4f}, Loss: {:.4f}".format(round, acc, max(accuracy),loss))
    #     if acc>=0.97:
    #         break
    round += 1
    if  round == 299:
        ...
        torch.save(checkpoint, './model_save/fmnist/SNN随机选择对比方法_Shards_localtrain{}_d{}_epoch{}_alpha{}_lr{}_seed{}.pth'
